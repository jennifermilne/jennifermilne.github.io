...
Select 'Model' and then 'Run model'

This code runs an animated environment moving a number of agents (as 
specified) for a number of iterations (as specified) and eating this 
environment as they move.

The agents start within the confines of a 100x100 graph, which is specified 
in the Agent Framework.

When they randomly move, if they reach the sides of the 300x300 graph 
currently set, they will move round to the other side of the environment and 
continue moving and eating there until the iterations are complete or until 
the window is closed.
 
Fianlly, the model will appear in the Spyder console with the completed 
iterations and showing where the agents ended up and the eaten environment.
"""
...
##################### This has moved to Agent Framework #####################
#############################################################################
...
"""
#############################################################################
################ Test to see if Agent Framework is working ##################
#############################################################################
